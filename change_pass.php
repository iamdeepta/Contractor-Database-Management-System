...
require("config/json_db.php");
        ...
        $data = getJSON("SELECT DISTINCT contractor.ContractorName, contractor.ID FROM tbl_contractor as contractor where Remove_Status=0 order by contractor.ContractorName asc");
        $result = json_decode($data, true);

        $data4 = getJSON("SELECT id, ProjectName from tbl_project_division where Remove_Status=0 order by ProjectName asc");
