...
<body>
	...
	<div class="limiter">
	    ...
	    <?php } ?>
					...
					<input type="text" readonly class="form-control-plaintext input1" style="width: 50px;" value="<?php echo $first_num?>">
					<input type="text" readonly class="form-control-plaintext input2" style="width: 50px;" value="<?php echo $operator?>">
					<input type="text" readonly class="form-control-plaintext input3" style="width: 50px;" value="<?php echo $second_num?>">
