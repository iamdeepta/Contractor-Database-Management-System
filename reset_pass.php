...
<body>
	...
	<div class="limiter">
	    ...
	    <?php } ?>
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Password is required" style="margin-top: 40px;">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Confirm password is required" style="margin-top: 40px;">
						<!-- <span class="label-input100">Username</span> -->
